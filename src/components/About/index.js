...
function About() {
  return (
    <section className='about'>
      <p id="about"><img className="myImage" src={require(`../../assets/images/ImageOfRonya.jpg`)} alt="Ronya Gettis by a body of water" />Hi! My name is Ronya Gettis, I am a recent graduate of the University of Minnesota Coding Bootcamp where I earned 
